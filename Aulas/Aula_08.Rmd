...
#### Para esses caso, pode-se recorrer a um Modelo Aditivo Generalizado (GAM) 
...
Na essência, o spline é um junção de várias funções base (lineares ou não)
...
Imaginemos uma função polinomial de tercerio grau ($d = 3$)
