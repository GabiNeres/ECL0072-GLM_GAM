...
A captura incidental de espécies não-alvo, i.e. *bycatch*, ocorre com frequência na pesca de espinhel.
  - Entender padrões espaço-temporais do bycatch é fundamental para propor medidas de manejo pesqueiro.
    ...
    > **Pergunta:** Em que época do ano são registradas as maiores capturas de bycatch? Espacialmente, há uma área mais vulnerável?
...
$$\large log(Y) = Z$$
$$\large Z \sim N(\mu, \sigma^2)$$

$$\large Y = e^Z \sim logN(\mu, \sigma^2)$$
...
- Pode-se modelar a captura-por-unidade-de-esforço (CPUE) das espécies alvo da pesca (todas juntas ou individualmente)
