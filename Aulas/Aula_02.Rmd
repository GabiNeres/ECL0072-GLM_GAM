...
knitr::include_graphics("../Figuras/MLE0.png")
```
...
```{r echo=FALSE, out.width ="85%", fig.align ='center'}
knitr::include_graphics("../Figuras/MLE1.png")
```
...
```{r echo=FALSE, out.width ="85%", fig.align ='center'}
knitr::include_graphics("../Figuras/MLE2.png")
```
...
```{r echo=FALSE, out.width ="85%", fig.align ='center'}
knitr::include_graphics("../Figuras/MLE3.png")
```
