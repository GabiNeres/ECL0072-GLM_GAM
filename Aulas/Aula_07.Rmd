...
**2. Distribuições para dados zero-inflacionadas**  
...
- **Zero-inflacionado**
     - Cap. 11: Mixed effect models and extensions in Ecology (Zuur)
     - Cap. 5 (seção 5.5): Extending the Linear model with R (Faraway)
     - Cap. 7 (seção 7.4): Foundations of Linear and Generalized Linear Models (Agresti, 2015)
     - Moreno et al. (2019). What does a zero mean? Understanding false, random and structural zeros in ecology. https://doi.org/10.1111/2041-210X.13185
     
- **Beta**
     - Cap. 3 (seção 3.6): Extending the Linear model with R (Faraway)
